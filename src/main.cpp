...
int main(int, char **)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // implot
        {
            int bar_data[7] = {2, 4, 5, 6, 7, 11, 22};
            int x_data[10] = {2, 4, 5, 6, 7, 11, 22, 33, 44, 55};
            int y_data[10] = {4, 5, 7, 8, 11, 23, 44, 56, 11, 56};
            //            Random(y_data, 1000, 1, 1000);
            //            Random(x_data, 1000, 1, 1000);
